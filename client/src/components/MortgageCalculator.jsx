        ...
        <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200">
          ...
          {result && (
            <div className="mt-8 p-4 bg-green-50 rounded-md border border-green-100">
              <h3 className="text-lg font-medium text-green-900">Estimated Monthly Payment</h3>
              <p className="text-3xl font-bold text-green-600 mt-2">${result.monthlyPayment}</p>
